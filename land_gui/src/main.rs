...
mod components;
use components::ThemeSelector::theme_selector;
...
impl Sandbox for Styling {
    ...
    fn view(&mut self) -> Element<Message> {
        let choose_theme = theme_selector(self.theme);
        ...
        let checkbox = Checkbox::new(self.toggle_value, "Allow RCS", Message::CheckboxToggled)
            .width(Length::Fill)
            .style(self.theme);
    ...
    mod dark {
        ...
        impl button::StyleSheet for Button {
            ...
            fn pressed(&self) -> button::Style {
                println!("SURFACE: {:?}", style::Theme::Dark);
