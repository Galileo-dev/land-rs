...
== Full convex optimization problem for atmospheric powered descent guidance

The full convex optimization problem for the atmospheric powered descent guidance is as follows:
