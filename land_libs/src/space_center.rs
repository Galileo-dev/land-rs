...
impl Control {
    ...
    /// <doc> <summary> Whether staging is locked on the vessel. </summary> <remarks> This is equivalent to locking the staging using Alt+L </remarks> </doc>
    pub fn set_stage_lock(&self, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Control_set_StageLock"));
...
impl RCS {
    ...
    pub fn set_thrust_limit(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RCS_set_ThrustLimit"));
